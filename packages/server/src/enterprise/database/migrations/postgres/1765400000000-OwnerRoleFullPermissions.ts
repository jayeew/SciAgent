 ...
 * (users:manage, roles:manage, sso:manage, workspace:view, loginActivity:view, etc.).
 * Previously owner had legacy permissions ["organization","workspace"] which did not
 * match frontend permission checks.
 */
